...
- **Scope (in):** Add the standard Mailchimp performance/tracking snippet to the site's global `<head>`.
- **Scope (out):** Design of actual pop-ups or forms (managed in Mailchimp UI).
- **Priority:** P2
- **Effort:** S
- **Acceptance signals:** Mailchimp script is present in the site's head in the production build.
- **Status: Done**
