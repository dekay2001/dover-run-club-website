...
- Contact section on homepage with dedicated email and Facebook group link
...
- **Status: Facebook + Strava live**
- Footer includes links to Strava and the Dover Run Club Facebook group
- Homepage "Stay in Touch" section includes Facebook group and contact email
- Future: Add Instagram when the account exists and has active moderation ownership
