...
### Canonical Backlog Entries

- **Title:** Community AI Safety Guidelines (Phase 1 copy slice)
- **Why now:** Members already use AI tools informally; lightweight guidance reduces misuse risk while preserving welcoming tone.
- **Scope (in):** Add short practical safety guidance directly on homepage; update roadmap status.
- **Scope (out):** No new navigation links, no new pages in header, no policy-heavy legal framing.
- **Priority:** P1
- **Effort:** S
- **Acceptance signals:**
	- Homepage includes 5 practical guidance bullets in friendly tone.
	- Main navigation remains unchanged.
	- What/When/Where/Vibe clarity remains intact.
- **Status:** Done

### Near-Term (when ready)

#### 🤖 Community AI Safety Guidelines
- **Status: Live (homepage section, Phase 1 compatible)**
- Practical guidance added to homepage under "Using AI Tools Safely (Optional)"
- Keeps guidance short, optional, and welcoming
- No changes to main navigation or hidden-page visibility
